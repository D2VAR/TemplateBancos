...
public class EnvioTransacaoPixConsumer {
    private final EnvioTransacaoPixInputPort envioTransacaoPixInputPort;

    @KafkaListener(id="id=${spring.kafka.consumer.group-id1", topics = "${topic.recebedor-envio-transacao-pix}")
    ...
    private void processConsumerRecord(ConsumerRecord<String, String> mensagemKafka) throws JsonProcessingException{
        ...
        envioTransacaoPixInputPort.enviarTransacaoPix(request);
    }
