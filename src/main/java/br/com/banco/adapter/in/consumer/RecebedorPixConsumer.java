...
public class RecebedorPixConsumer {
    ...
    @KafkaListener(id = "spring.kafka.consumer.group-recebedor", topics = "${topic.fim.transacao.pix.success}")
    ...
    @KafkaListener(id = "${spring.kafka.consumer.group-id2}", topics = "${topic.fim.transacao.pix.fail}")
