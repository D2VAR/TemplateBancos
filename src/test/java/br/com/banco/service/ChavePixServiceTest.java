...
public class ChavePixServiceTest {
    ...
    @Mock
    private BacenProducerOutputPort bacenProducerOutputPort;
    ...
    public void deleteChavePixTest() {
        ...
        service.deleteById(UUID.fromString("315fb189-12b5-47ad-980b-ea749cc21539"));
        verify(repository, times(1))
                .deleteById(UUID.fromString("315fb189-12b5-47ad-980b-ea749cc21539"));
    }
    ...
    public void cadastrarChaveBacenTest() {
        when(contaService.getContaById(UUID.fromString("2cc89acb-0522-4768-92cb-459d3482f889")))
        ...
        verify(bacenProducerOutputPort, times(1)).enviarMensagemCadastroChave(any());
